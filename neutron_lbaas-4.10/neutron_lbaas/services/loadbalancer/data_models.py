...
class Listener(BaseDataModel):
    ...
    def __init__(self, id=None, tenant_id=None, name=None, description=None,
                 ...
                 l7_policies=None, transparent=None, mutual_authentication_up=None,
                 ...
                 customized=None, keepalive_timeout=None, proxy_protocol=None):
        self.id = id
        self.tenant_id = tenant_id
        self.name = name
        self.description = description
...
class ACLGroup(BaseDataModel):
    fields = ['id', 'tenant_id', 'name', 'description',
              'region', 'listeners', 'acl_rules']

    def __init__(self, id=None, tenant_id=None, name=None, description=None,
                 region=None, listeners=None, acl_rules=None):
        self.id = id
        self.tenant_id = tenant_id
        self.name = name
        self.description = description
    ...
    def to_api_dict(self):
        ret_dict = super(ACLGroup, self).to_dict(
            listeners=False, acl_rules=False)
    ...
    @classmethod
    def from_dict(cls, model_dict):
        return super(ACLGroup, cls).from_dict(model_dict)


class ACLRule(BaseDataModel):
    fields = ['id', 'tenant_id', 'description',
              'ip_version', 'ip_address', 'acl_group_id']

    def __init__(self, id=None, tenant_id=None, description=None,
                 ip_version=None, ip_address=None, acl_group_id=None):
        self.id = id
        self.tenant_id = tenant_id
        self.description = description
        self.ip_version = ip_version
    ...
    def to_api_dict(self):
        ret_dict = super(ACLRule, self).to_dict()
        return ret_dict

    @classmethod
    def from_dict(cls, model_dict):
        return super(ACLRule, cls).from_dict(model_dict)


class ACLGroupListenerBinding(BaseDataModel):
    fields = ['listener_id', 'acl_group_id', 'type', 'enabled']

    def __init__(self, listener_id=None, acl_group_id=None, type=None,
                 enabled=None):
        self.listener_id = listener_id
        self.acl_group_id = acl_group_id
        self.type = type
    ...
    def to_api_dict(self):
        ret_dict = super(ACLGroupListenerBinding, self).to_dict()
        return ret_dict

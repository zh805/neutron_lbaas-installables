...
class CreateL7Rule(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            '--project',
            metavar='<project>',
            help="Project for the l7rule (name or ID)."
        )
        parser.add_argument(
            '--compare-type',
    ...
    def take_action(self, parsed_args):
        ...
        body = {"rule": attrs}
        data = self.app.client_manager.neutronclient.create_lbaas_l7rule(
...
class DeleteL7Rule(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.neutronclient.delete_lbaas_l7rule(
            attrs['l7rule_id'], attrs['l7policy_id'])
...
class ListL7Rule(lister.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        data = self.app.client_manager.neutronclient.list_lbaas_l7rules(
            attrs['l7policy_id'])
...
class ShowL7Rule(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        attrs = v2_utils.get_l7rule_attrs(self.app.client_manager, parsed_args)
        data = self.app.client_manager.neutronclient.show_lbaas_l7rule(
            attrs['l7rule_id'], attrs['l7policy_id'])
...
class SetL7Rule(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.neutronclient.update_lbaas_l7rule(
            l7rule_id, l7policy_id, body=body)

...
class ListMember(lister.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        data = self.app.client_manager.neutronclient.list_lbaas_members(
            pool_id)
...
class ShowMember(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        data = self.app.client_manager.neutronclient.show_lbaas_member(
            member_id, pool_id)
...
class CreateMember(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            '--project',
            metavar='<project>',
            help="Project for the member(name or ID)."
        )
        parser.add_argument(
            '--weight',
            metavar='<weight>',
    ...
    def take_action(self, parsed_args):
        ...
        body = {"member": attrs}
        data = self.app.client_manager.neutronclient.create_lbaas_member(
            pool_id, body=body)
...
class SetMember(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.neutronclient.update_lbaas_member(
            member_id, pool_id, body=post_data)
...
class DeleteMember(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.neutronclient.delete_lbaas_member(
            id, pool_id)
